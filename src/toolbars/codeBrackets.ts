...
export class CodeBrackets {
    public element: HTMLElement;
    public editor: Editor;

    constructor(editor:Editor) {
        this.element = document.createElement("div");
        this.element.className = "hw-toolbar_item hw-toolbar_codeBrackets";
        this.element.innerHTML = icons.CodeBrackets;
        this.element.setAttribute("data-type", "codeBrackets");
        this.editor = editor
